					...
					<Section heading="Bio" className="pt-8">
						<div className="flex flex-col lg:flex-row gap-3">
							<ul className="flex flex-col justify-between items-start space-y-5 lg:w-1/2">
								...
								<li className="transition-opacity">
									<b>2019</b>・Starting learning development
									in autodidact.
								</li>
								<li className="transition-opacity">
								...
								<li className="transition-opacity">
									<b>2022</b>・Work at Nicoka (as Developer
									back in internership)
								</li>
								<li>
									<b>2022</b>・Work at Azerty Consulting (as
									Developer Full Stack)
								</li>
								<li className="transition-opacity">
									<b>2023 - Present</b>・Enter at 42 School
									Bangkok.
								</li>
							</ul>
							<div className="flex flex-col gap-5 pt-8 lg:pt-0 lg:w-1/2">
								<h3 className="text-2xl md:text-1xl text-tertiary">
									Who i am
								</h3>
								<p className="text-secondary text-justify">
									...
									innovative IT solutions solutions and always
									striving to to improve.
								</p>
								<p className="text-secondary text-justify">
									I&apo;m passionate about development, but
									also about travel and the different cultures
									of the world. Every line of code I write is
									about connecting people and their ideas. I
									also enjoy discovering new places to broaden
									my perspective.
								</p>
								<p className="text-secondary text-justify">
									<b className="font-extrabold text-[#0171e2]">
									...
									is another of my passions. Its diversity and
									creativity inspire me in my personal life.
									There&apos;s a harmony between my passion
									for coding and my love of music music, which
									makes me a dedicated, inquisitive and a
									dedicated student, curious and in love with
									life.
								</p>
							</div>
						</div>
